...
public class AavCoreServiceController {

  private final AavCoreService aavCoreService;
  ...
  public ResponseEntity<Double> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    Double data = aavCoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

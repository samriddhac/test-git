package demo.fihub.core.order.v1.test.exception.impl;
...
import com.macys.order.foundation.core.utils.exception.ErrorDetail;
...
public class DataExceptionHandler
  ...
  public void handleException(JoinPoint joinPoint, Throwable error) {
    ...
    if (throwable instanceof io.grpc.StatusRuntimeException) {
      ...
      com.macys.order.foundation.core.utils.exception.Error dataError =
          com.macys.order.foundation.core.utils.exception.Error.builder()

package demo.fihub.composite.order.collect.controller;
...
public class OrderCollectCompositeServiceController {

  private final IOrderCollectCompositeService orderCollectCompositeService;
  ...
  public ResponseEntity<List<Order>> getReturnsByCustomerOrderId(
    ...
    List<Order> data = orderCollectCompositeService.getReturnsByCustomerOrderId(customerOrderId);
    if (data != null) {
  ...
  public ResponseEntity<List<OrderTransactions>> getReturnsByOrderId(
    ...
    List<OrderTransactions> data = orderCollectCompositeService.getReturnsByOrderId(orderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> publishReturnProcessEvent(
    ...
    Order data = orderCollectCompositeService.publishReturnProcessEvent(Order);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getReturnByOrderId(
    ...
    Order data = orderCollectCompositeService.getReturnByOrderId(OrderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

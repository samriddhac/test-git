package demo.fihub.composite.order.collect.v3.controller;
...
public class OrderCollectV3CompositeServiceController {

  private final IOrderCollectV3CompositeService orderCollectV3CompositeService;
  ...
  public ResponseEntity<List<Order>> getReturnsByCustomerOrderId(
    ...
    List<Order> data = orderCollectV3CompositeService.getReturnsByCustomerOrderId(customerOrderId);
    if (data != null) {
  ...
  public ResponseEntity<List<OrderTransactions>> getReturnsByOrderId(
    ...
    List<OrderTransactions> data = orderCollectV3CompositeService.getReturnsByOrderId(orderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> publishReturnProcessEvent(
    ...
    Order data = orderCollectV3CompositeService.publishReturnProcessEvent(Order);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getReturnByOrderId(
    ...
    Order data = orderCollectV3CompositeService.getReturnByOrderId(OrderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

package demo.fihub.composite.order.collect.v2.controller;
...
public class OrderCollectV2CompositeServiceController {

  private final IOrderCollectV2CompositeService orderCollectV2CompositeService;
  ...
  public ResponseEntity<List<Order>> getReturnsByCustomerOrderId(
    ...
    List<Order> data = orderCollectV2CompositeService.getReturnsByCustomerOrderId(customerOrderId);
    if (data != null) {
  ...
  public ResponseEntity<List<OrderTransactions>> getReturnsByOrderId(
    ...
    List<OrderTransactions> data = orderCollectV2CompositeService.getReturnsByOrderId(orderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> publishReturnProcessEvent(
    ...
    Order data = orderCollectV2CompositeService.publishReturnProcessEvent(Order);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getReturnByOrderId(
    ...
    Order data = orderCollectV2CompositeService.getReturnByOrderId(OrderId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

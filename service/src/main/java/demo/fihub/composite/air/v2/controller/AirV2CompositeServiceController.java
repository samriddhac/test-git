package demo.fihub.composite.air.v2.controller;
...
public class AirV2CompositeServiceController {
  ...
  public ResponseEntity<List<Aircraft>> getAircrafts() {
    ...
    List<Aircraft> data = airV2CompositeService.getAircrafts();
    if (data != null) {
  ...
  public ResponseEntity<Void> postAircrafts(
    ...
    airV2CompositeService.postAircrafts(body);
  ...
  public ResponseEntity<Aircraft> getAircraft(
    ...
    Aircraft data = airV2CompositeService.getAircraft(aircraftId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Void> putAircraft(
    ...
    airV2CompositeService.putAircraft(aircraftId, body);
  ...
  public ResponseEntity<Void> deleteAircraft(
    ...
    airV2CompositeService.deleteAircraft(aircraftId);
    return new ResponseEntity<>(HttpStatus.NO_CONTENT);
  }
}

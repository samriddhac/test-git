package demo.fihub.composite.air.v3.controller;
...
public class AirV3CompositeServiceController {
  ...
  public ResponseEntity<List<Aircraft>> getAircrafts() {
    ...
    List<Aircraft> data = airV3CompositeService.getAircrafts();
    if (data != null) {
  ...
  public ResponseEntity<Void> postAircrafts(
    ...
    airV3CompositeService.postAircrafts(body);
  ...
  public ResponseEntity<Aircraft> getAircraft(
    ...
    Aircraft data = airV3CompositeService.getAircraft(aircraftId);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Void> putAircraft(
    ...
    airV3CompositeService.putAircraft(aircraftId, body);
  ...
  public ResponseEntity<Void> deleteAircraft(
    ...
    airV3CompositeService.deleteAircraft(aircraftId);
    return new ResponseEntity<>(HttpStatus.NO_CONTENT);
  }
}

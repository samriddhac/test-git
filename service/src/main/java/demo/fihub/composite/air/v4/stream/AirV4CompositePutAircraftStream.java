...
@Component
public class AirV4CompositePutAircraftStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.putaircraft.name}")
  ...
  public AirV4CompositePutAircraftStream(

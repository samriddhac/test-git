...
public abstract class AbstractOrderIdV7CoreServiceHelper
  ...
  public List<OrderTransactions> getReturnsByOrderId(String serviceCallId) {
    ...
    ResponseEntity<OrderTransactions[]> responseEntityOrderIdV7CoreService = null;
    ServiceData serviceDataOrderIdV7CoreService = null;
    serviceRequestContextOrderIdV7CoreService = processGetReturnsByOrderIdRequest(serviceCallId);
    setDefaultHeaders(serviceRequestContextOrderIdV7CoreService);
    serviceRequestContextOrderIdV7CoreService.setUrl(
        UriComponentsBuilder.fromHttpUrl((baseUriOrderIdV7CoreService + "/returndetails/{orderId}"))

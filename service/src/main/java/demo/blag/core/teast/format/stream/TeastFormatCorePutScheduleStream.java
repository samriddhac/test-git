...
@Component
public class TeastFormatCorePutScheduleStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.putschedule.name}")
  ...
  public TeastFormatCorePutScheduleStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    teastFormatCoreService.putSchedule(source);
  }

...
@Component
public class TeastFormatCoreGetSchedulesStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.getschedules.name}")
  ...
  public TeastFormatCoreGetSchedulesStream(

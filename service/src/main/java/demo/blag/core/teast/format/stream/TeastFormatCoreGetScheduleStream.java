...
@Component
public class TeastFormatCoreGetScheduleStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.getschedule.name}")
  ...
  public TeastFormatCoreGetScheduleStream(

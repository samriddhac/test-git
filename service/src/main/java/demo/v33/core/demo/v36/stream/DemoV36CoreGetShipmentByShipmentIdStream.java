...
@Component
public class DemoV36CoreGetShipmentByShipmentIdStream extends AbstractStreamSubscriber
  ...
  public DemoV36CoreGetShipmentByShipmentIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    demoV36CoreService.getShipmentByShipmentId(source);
  }

...
@Component
public class DemoV36CoreGetAllShipmentByPONumberStream extends AbstractStreamSubscriber
  ...
  public DemoV36CoreGetAllShipmentByPONumberStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    demoV36CoreService.getAllShipmentByPONumber(source);
  }

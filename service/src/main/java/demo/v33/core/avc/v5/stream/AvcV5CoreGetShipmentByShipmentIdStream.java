...
@Component
public class AvcV5CoreGetShipmentByShipmentIdStream extends AbstractStreamSubscriber
  ...
  public AvcV5CoreGetShipmentByShipmentIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    avcV5CoreService.getShipmentByShipmentId(source);
  }

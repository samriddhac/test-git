...
public class AvcV3CoreServiceController {

  private final AvcV3CoreService avcV3CoreService;
  ...
  public ResponseEntity<Order> createShipment(
    ...
    Order data = avcV3CoreService.createShipment(shipmentRequest);
    if (data != null) {
  ...
  public ResponseEntity<Order> getAllShipmentByPONumber(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV3CoreService.getAllShipmentByPONumber(ponumber);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getShipmentByShipmentRef(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV3CoreService.getShipmentByShipmentRef(shipmentref);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getAllShipmentByOrderId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV3CoreService.getAllShipmentByOrderId(shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> updateShipment(
      @ApiParam(value = "shipmentRequest", required = true)
          ...
          @RequestBody
          Order shipmentRequest) {
    Order data = avcV3CoreService.updateShipment(shipmentRequest);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getShipmentByShipmentId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV3CoreService.getShipmentByShipmentId(shipmentid, shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

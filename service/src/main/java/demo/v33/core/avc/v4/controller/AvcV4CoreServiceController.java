package demo.v33.core.avc.v4.controller;
...
public class AvcV4CoreServiceController {

  private final AvcV4CoreService avcV4CoreService;
  ...
  public ResponseEntity<Order> createShipment(
    ...
    Order data = avcV4CoreService.createShipment(shipmentRequest);
    if (data != null) {
  ...
  public ResponseEntity<Order> getAllShipmentByPONumber(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV4CoreService.getAllShipmentByPONumber(ponumber);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getShipmentByShipmentRef(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV4CoreService.getShipmentByShipmentRef(shipmentref);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getAllShipmentByOrderId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV4CoreService.getAllShipmentByOrderId(shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> updateShipment(
      @ApiParam(value = "shipmentRequest", required = true)
          ...
          @RequestBody
          Order shipmentRequest) {
    Order data = avcV4CoreService.updateShipment(shipmentRequest);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Order> getShipmentByShipmentId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    Order data = avcV4CoreService.getShipmentByShipmentId(shipmentid, shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

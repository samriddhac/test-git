package demo.v33.core.avc.dao.impl;
...
public class AvcCoreDaoImpl implements AvcCoreDao {
  ...
  public Order getAllShipmentByPONumber(String ponumber) {
    ...
    demo.v33.core.avc.dao.entity.Object objectEntity =
        spannerTemplate.read(demo.v33.core.avc.dao.entity.Object.class, key);
    Order order = null;
  ...
  public Order getShipmentByShipmentId(int shipmentid, String shipmentorderid) {
    ...
    demo.v33.core.avc.dao.entity.OrderLine orderLineEntity =
        spannerTemplate.read(demo.v33.core.avc.dao.entity.OrderLine.class, key);
    Order order = null;

package demo.v33.composite.shipment.comp.v1.controller;
...
public class ShipmentCompV1CompositeServiceController {
  ...
  public ResponseEntity<com.abcd.uop.model.Order> createShipment(
    ...
    com.abcd.uop.model.Order data = shipmentCompV1CompositeService.createShipment(shipmentRequest);
    if (data != null) {
  ...
  public ResponseEntity<com.abcd.uop.returning.model.Order> getAllShipmentByPONumber(
    ...
    com.abcd.uop.returning.model.Order data =
        shipmentCompV1CompositeService.getAllShipmentByPONumber(ponumber);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> getShipmentByShipmentRef(
    ...
    com.abcd.uop.model.Order data =
        shipmentCompV1CompositeService.getShipmentByShipmentRef(shipmentref);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> getAllShipmentByOrderId(
    ...
    com.abcd.uop.model.Order data =
        shipmentCompV1CompositeService.getAllShipmentByOrderId(shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> updateShipment(
    ...
    com.abcd.uop.model.Order data = shipmentCompV1CompositeService.updateShipment(shipmentRequest);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<BadOrder> getShipmentByShipmentId(
    ...
    BadOrder data =
        shipmentCompV1CompositeService.getShipmentByShipmentId(shipmentid, shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

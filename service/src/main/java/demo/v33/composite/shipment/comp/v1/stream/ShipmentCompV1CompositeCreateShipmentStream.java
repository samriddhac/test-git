...
@Component
public class ShipmentCompV1CompositeCreateShipmentStream extends AbstractStreamSubscriber
  ...
  public ShipmentCompV1CompositeCreateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentCompV1CompositeService.createShipment(source);
  }

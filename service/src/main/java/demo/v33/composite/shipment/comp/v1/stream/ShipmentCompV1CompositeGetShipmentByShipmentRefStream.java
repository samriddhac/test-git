...
@Component
public class ShipmentCompV1CompositeGetShipmentByShipmentRefStream extends AbstractStreamSubscriber
    implements ServiceContextUtil {

  @Value("${topic.subscription.getshipmentbyshipmentref.name}")
  ...
  public ShipmentCompV1CompositeGetShipmentByShipmentRefStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentCompV1CompositeService.getShipmentByShipmentRef(source);
  }

...
@Component
public class ShipmentCompV1CompositeGetAllShipmentByPONumberStream extends AbstractStreamSubscriber
  ...
  public ShipmentCompV1CompositeGetAllShipmentByPONumberStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentCompV1CompositeService.getAllShipmentByPONumber(source);
  }

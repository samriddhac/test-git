...
@Component
public class ShipmentCompV1CompositeGetShipmentByShipmentIdStream extends AbstractStreamSubscriber
  ...
  public ShipmentCompV1CompositeGetShipmentByShipmentIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentCompV1CompositeService.getShipmentByShipmentId(source);
  }

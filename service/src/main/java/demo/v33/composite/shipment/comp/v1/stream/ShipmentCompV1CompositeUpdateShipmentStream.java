...
@Component
public class ShipmentCompV1CompositeUpdateShipmentStream extends AbstractStreamSubscriber
  ...
  public ShipmentCompV1CompositeUpdateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentCompV1CompositeService.updateShipment(source);
  }

...
public class VarfV1CoreServiceController {

  private final VarfV1CoreService varfV1CoreService;
  ...
  public ResponseEntity<List<List<Order>>> groupLogicalShipments(
    ...
    List<List<Order>> data = varfV1CoreService.groupLogicalShipments(lineItemArray);
    if (data != null) {

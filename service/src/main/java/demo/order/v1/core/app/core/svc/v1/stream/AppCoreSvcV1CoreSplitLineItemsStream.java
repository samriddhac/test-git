...
@Component
public class AppCoreSvcV1CoreSplitLineItemsStream extends AbstractStreamSubscriber
  ...
  public AppCoreSvcV1CoreSplitLineItemsStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    appCoreSvcV1CoreService.splitLineItems(source);
  }

...
@Component
public class BcdfeV1CoreGetAllShipmentByOrderIdStream extends AbstractStreamSubscriber
  ...
  public BcdfeV1CoreGetAllShipmentByOrderIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    bcdfeV1CoreService.getAllShipmentByOrderId(source);
  }

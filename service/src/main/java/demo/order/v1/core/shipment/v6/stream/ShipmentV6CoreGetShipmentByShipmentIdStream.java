...
@Component
public class ShipmentV6CoreGetShipmentByShipmentIdStream extends AbstractStreamSubscriber
  ...
  public ShipmentV6CoreGetShipmentByShipmentIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentV6CoreService.getShipmentByShipmentId(source);
  }

...
public class GroupV2CoreServiceController {

  private final GroupV2CoreService groupV2CoreService;
  ...
  public ResponseEntity<List<List<Order>>> groupLogicalShipments(
    ...
    List<List<Order>> data = groupV2CoreService.groupLogicalShipments(lineItemArray);
    if (data != null) {

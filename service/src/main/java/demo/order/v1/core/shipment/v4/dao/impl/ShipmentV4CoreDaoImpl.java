package demo.order.v1.core.shipment.v4.dao.impl;
...
public class ShipmentV4CoreDaoImpl implements ShipmentV4CoreDao {
  ...
  public com.abcd.uop.returning.model.Order getAllShipmentByPONumber(String ponumber) {
    ...
    demo.order.v1.core.shipment.v4.dao.entity.OrderMaster orderMasterEntity =
        spannerTemplate.read(demo.order.v1.core.shipment.v4.dao.entity.OrderMaster.class, key);

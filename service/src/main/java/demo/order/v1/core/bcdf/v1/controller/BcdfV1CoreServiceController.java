...
public class BcdfV1CoreServiceController {

  private final BcdfV1CoreService bcdfV1CoreService;
  ...
  public ResponseEntity<String> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    String data = bcdfV1CoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

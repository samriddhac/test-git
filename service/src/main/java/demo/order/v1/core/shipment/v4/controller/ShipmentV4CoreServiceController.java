...
public class ShipmentV4CoreServiceController {

  private final ShipmentV4CoreService shipmentV4CoreService;
  ...
  public ResponseEntity<com.abcd.uop.model.Order> createShipment(
    ...
    com.abcd.uop.model.Order data = shipmentV4CoreService.createShipment(shipmentRequest);
    if (data != null) {
  ...
  public ResponseEntity<com.abcd.uop.returning.model.Order> getAllShipmentByPONumber(
    ...
    com.abcd.uop.returning.model.Order data =
        shipmentV4CoreService.getAllShipmentByPONumber(ponumber);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> getShipmentByShipmentRef(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    com.abcd.uop.model.Order data = shipmentV4CoreService.getShipmentByShipmentRef(shipmentref);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> getAllShipmentByOrderId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    com.abcd.uop.model.Order data = shipmentV4CoreService.getAllShipmentByOrderId(shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<com.abcd.uop.model.Order> updateShipment(
      @ApiParam(value = "shipmentRequest", required = true)
          ...
          @RequestBody
          com.abcd.uop.model.Order shipmentRequest) {
    com.abcd.uop.model.Order data = shipmentV4CoreService.updateShipment(shipmentRequest);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<BadOrder> getShipmentByShipmentId(
      ...
      @ApiParam(value = "filter", required = false) @RequestParam(value = "filter", required = true)
          boolean filter) {
    BadOrder data = shipmentV4CoreService.getShipmentByShipmentId(shipmentid, shipmentorderid);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

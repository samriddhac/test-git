...
@Component
public class BcdfeV1CoreUpdateShipmentStream extends AbstractStreamSubscriber
  ...
  public BcdfeV1CoreUpdateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    bcdfeV1CoreService.updateShipment(source);
  }

...
public class BilluV1CoreServiceController {

  private final BilluV1CoreService billuV1CoreService;
  ...
  public ResponseEntity<String> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    String data = billuV1CoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

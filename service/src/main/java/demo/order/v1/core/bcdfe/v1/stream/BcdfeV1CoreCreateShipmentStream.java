...
@Component
public class BcdfeV1CoreCreateShipmentStream extends AbstractStreamSubscriber
  ...
  public BcdfeV1CoreCreateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    bcdfeV1CoreService.createShipment(source);
  }

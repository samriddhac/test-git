...
public class OrderAbcV1CoreServiceController {

  private final OrderAbcV1CoreService orderAbcV1CoreService;
  ...
  public ResponseEntity<Order> createOrder(
      @ApiParam(value = "", required = true) @Validated({CreateGroup.class}) @RequestBody
          Order body) {
    Order data = orderAbcV1CoreService.createOrder(body);
    if (data != null) {

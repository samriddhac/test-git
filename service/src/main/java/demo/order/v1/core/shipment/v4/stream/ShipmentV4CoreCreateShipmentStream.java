...
@Component
public class ShipmentV4CoreCreateShipmentStream extends AbstractStreamSubscriber
  ...
  public ShipmentV4CoreCreateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentV4CoreService.createShipment(source);
  }

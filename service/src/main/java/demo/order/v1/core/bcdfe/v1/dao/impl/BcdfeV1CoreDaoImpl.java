package demo.order.v1.core.bcdfe.v1.dao.impl;
...
import demo.order.v1.core.bcdfe.v1.dao.mapper.OrderToOrderMapper;
import demo.order.v1.core.bcdfe.v1.dao.mapper.ReturnOrderToReturnOrderMapper;
import demo.order.v1.core.bcdfe.v1.dao.mapper.BadOrderToBadOrderMapper;
...
public class BcdfeV1CoreDaoImpl implements BcdfeV1CoreDao {
  ...
  public com.abcd.uop.returning.model.Order getAllShipmentByPONumber(String ponumber) {
    ...
    demo.order.v1.core.bcdfe.v1.dao.entity.OrderMaster orderMasterEntity =
        spannerTemplate.read(demo.order.v1.core.bcdfe.v1.dao.entity.OrderMaster.class, key);

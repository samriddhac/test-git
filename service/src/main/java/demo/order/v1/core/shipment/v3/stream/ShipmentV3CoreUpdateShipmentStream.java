...
@Component
public class ShipmentV3CoreUpdateShipmentStream extends AbstractStreamSubscriber
  ...
  public ShipmentV3CoreUpdateShipmentStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    shipmentV3CoreService.updateShipment(source);
  }

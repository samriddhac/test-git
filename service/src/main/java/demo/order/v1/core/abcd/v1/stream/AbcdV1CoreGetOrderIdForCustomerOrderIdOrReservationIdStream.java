package demo.order.v1.core.abcd.v1.stream;
...
import demo.order.v1.core.abcd.v1.service.IAbcdV1CoreService;

import brave.Tracer;

@Component
public class AbcdV1CoreGetOrderIdForCustomerOrderIdOrReservationIdStream
  ...
  private final IAbcdV1CoreService abcdV1CoreService;

  public AbcdV1CoreGetOrderIdForCustomerOrderIdOrReservationIdStream(
      PubSubTemplate pubSubTemplate,
      MessageValidator messageValidator,
      JsonUtils jsonUtils,
      Logger logger,
      Tracer tracer,
      IAbcdV1CoreService abcdV1CoreService) {
    super(pubSubTemplate, messageValidator, logger, tracer);
    this.abcdV1CoreService = abcdV1CoreService;

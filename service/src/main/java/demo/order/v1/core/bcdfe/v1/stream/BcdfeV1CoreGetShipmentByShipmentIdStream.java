...
@Component
public class BcdfeV1CoreGetShipmentByShipmentIdStream extends AbstractStreamSubscriber
  ...
  public BcdfeV1CoreGetShipmentByShipmentIdStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    bcdfeV1CoreService.getShipmentByShipmentId(source);
  }

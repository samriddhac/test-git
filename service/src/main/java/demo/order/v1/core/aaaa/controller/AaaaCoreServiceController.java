...
public class AaaaCoreServiceController {

  private final AaaaCoreService aaaaCoreService;
  ...
  public ResponseEntity<String> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    String data = aaaaCoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

...
@Component
public class BcdfeV1CoreGetShipmentByShipmentRefStream extends AbstractStreamSubscriber
  ...
  public BcdfeV1CoreGetShipmentByShipmentRefStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    bcdfeV1CoreService.getShipmentByShipmentRef(source);
  }

...
public class AasssV1CoreServiceController {

  private final AasssV1CoreService aasssV1CoreService;
  ...
  public ResponseEntity<Double> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    Double data = aasssV1CoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

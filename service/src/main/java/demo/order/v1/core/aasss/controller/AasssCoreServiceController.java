...
public class AasssCoreServiceController {

  private final AasssCoreService aasssCoreService;
  ...
  public ResponseEntity<Double> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    Double data = aasssCoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

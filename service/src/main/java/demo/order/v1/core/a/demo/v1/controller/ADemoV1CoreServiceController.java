...
public class ADemoV1CoreServiceController {

  private final ADemoV1CoreService aDemoV1CoreService;
  ...
  public ResponseEntity<String> getOrderIdForCustomerOrderIdOrReservationId(
    ...
    String data = aDemoV1CoreService.getOrderIdForCustomerOrderIdOrReservationId();
    if (data != null) {

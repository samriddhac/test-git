...
public class MapperTestCoreServiceController {

  private final MapperTestCoreService mapperTestCoreService;
  ...
  public ResponseEntity<List<List<Order>>> groupLogicalShipments(
    ...
    List<List<Order>> data = mapperTestCoreService.groupLogicalShipments(lineItemArray);
    if (data != null) {

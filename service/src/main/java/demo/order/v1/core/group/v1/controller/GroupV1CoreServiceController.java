...
public class GroupV1CoreServiceController {

  private final GroupV1CoreService groupV1CoreService;
  ...
  public ResponseEntity<List<List<Order>>> groupLogicalShipments(
    ...
    List<List<Order>> data = groupV1CoreService.groupLogicalShipments(lineItemArray);
    if (data != null) {

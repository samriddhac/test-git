...
@Component
public class AppCompSvcV1CompositeSplitLineItemsStream extends AbstractStreamSubscriber
  ...
  public AppCompSvcV1CompositeSplitLineItemsStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    appCompSvcV1CompositeService.splitLineItems(source);
  }

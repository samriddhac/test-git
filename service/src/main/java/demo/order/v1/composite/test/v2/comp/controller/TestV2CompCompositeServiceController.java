package demo.order.v1.composite.test.v2.comp.controller;
...
public class TestV2CompCompositeServiceController {

  private final ITestV2CompCompositeService testV2CompCompositeService;
  ...
  public ResponseEntity<com.abcd.uop.model.Order> collectOrder(
    ...
    com.abcd.uop.model.Order data = testV2CompCompositeService.collectOrder(body);
    if (data != null) {
  ...
  public ResponseEntity<com.abcd.oop.model.Order> updateOrder(
    ...
    com.abcd.oop.model.Order data = testV2CompCompositeService.updateOrder(body);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

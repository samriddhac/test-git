...
@Component
public class AppArrayV1CompositeSplitLineItemsStream extends AbstractStreamSubscriber
  ...
  public AppArrayV1CompositeSplitLineItemsStream(
  ...
  protected void invokeService(PubsubMessage message) {
    ...
    appArrayV1CompositeService.splitLineItems(source);
  }

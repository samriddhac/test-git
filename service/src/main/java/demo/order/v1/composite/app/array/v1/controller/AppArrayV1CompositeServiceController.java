package demo.order.v1.composite.app.array.v1.controller;
...
public class AppArrayV1CompositeServiceController {
  ...
  public ResponseEntity<List<List<Order>>> groupLogicalShipments(
    ...
    List<List<Order>> data = appArrayV1CompositeService.groupLogicalShipments(lineItemArray);
    if (data != null) {
  ...
  public ResponseEntity<List<List<Order>>> splitLineItems(
    ...
    List<List<Order>> data = appArrayV1CompositeService.splitLineItems(lineItemArray);
    if (data != null) {
      return new ResponseEntity<>(data, HttpStatus.OK);
    } else {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);

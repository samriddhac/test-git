...
import demo.order.v1.core.shipment.v6.controller.ShipmentV6CoreServiceController;
import demo.order.v1.core.shipment.v6.service.ShipmentV6CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(ShipmentV6CoreServiceController.class)
public class ShipmentV6CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private ShipmentV6CoreService shipmentV6CoreService;

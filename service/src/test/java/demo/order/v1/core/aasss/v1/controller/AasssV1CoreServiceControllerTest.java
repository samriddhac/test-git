package demo.order.v1.core.aasss.v1.controller;
...
import demo.order.v1.core.aasss.v1.controller.AasssV1CoreServiceController;
import demo.order.v1.core.aasss.v1.service.AasssV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(AasssV1CoreServiceController.class)
public class AasssV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private AasssV1CoreService aasssV1CoreService;

package demo.order.v1.core.group.v2.controller;
...
import demo.order.v1.core.group.v2.controller.GroupV2CoreServiceController;
import demo.order.v1.core.group.v2.service.GroupV2CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(GroupV2CoreServiceController.class)
public class GroupV2CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private GroupV2CoreService groupV2CoreService;

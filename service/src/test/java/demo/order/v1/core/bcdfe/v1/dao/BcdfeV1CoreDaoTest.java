...
import demo.order.v1.core.bcdfe.v1.dao.config.TestConfiguration;

import demo.order.v1.core.bcdfe.v1.dao.mapper.*;
import demo.order.v1.core.bcdfe.v1.dao.mapper.*;
import demo.order.v1.core.bcdfe.v1.dao.mapper.*;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = TestConfiguration.class)
public class BcdfeV1CoreDaoTest {
  @Autowired private BcdfeV1CoreDao bcdfeV1CoreDao;

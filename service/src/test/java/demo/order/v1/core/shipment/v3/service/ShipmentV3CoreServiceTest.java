...
import demo.order.v1.core.shipment.v3.service.config.TestConfiguration;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = TestConfiguration.class)
public class ShipmentV3CoreServiceTest {

  @Autowired private ShipmentV3CoreService shipmentV3CoreService;

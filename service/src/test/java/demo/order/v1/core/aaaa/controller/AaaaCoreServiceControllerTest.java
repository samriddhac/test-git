package demo.order.v1.core.aaaa.controller;
...
import demo.order.v1.core.aaaa.controller.AaaaCoreServiceController;
import demo.order.v1.core.aaaa.service.AaaaCoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(AaaaCoreServiceController.class)
public class AaaaCoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private AaaaCoreService aaaaCoreService;

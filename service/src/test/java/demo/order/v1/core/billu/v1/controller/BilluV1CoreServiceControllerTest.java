package demo.order.v1.core.billu.v1.controller;
...
import demo.order.v1.core.billu.v1.controller.BilluV1CoreServiceController;
import demo.order.v1.core.billu.v1.service.BilluV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(BilluV1CoreServiceController.class)
public class BilluV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private BilluV1CoreService billuV1CoreService;

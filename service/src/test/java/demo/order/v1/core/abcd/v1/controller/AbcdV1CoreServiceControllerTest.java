...
import demo.order.v1.core.abcd.v1.controller.AbcdV1CoreServiceController;
import demo.order.v1.core.abcd.v1.service.AbcdV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(AbcdV1CoreServiceController.class)
public class AbcdV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private AbcdV1CoreService abcdV1CoreService;

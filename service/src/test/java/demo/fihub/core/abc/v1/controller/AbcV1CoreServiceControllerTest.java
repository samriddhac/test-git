...
import demo.fihub.core.abc.v1.controller.AbcV1CoreServiceController;
import demo.fihub.core.abc.v1.service.AbcV1CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(AbcV1CoreServiceController.class)
public class AbcV1CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private AbcV1CoreService abcV1CoreService;

...
import demo.fihub.core.blah.test.controller.BlahTestCoreServiceController;
import demo.fihub.core.blah.test.service.BlahTestCoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(BlahTestCoreServiceController.class)
public class BlahTestCoreServiceControllerTest {

  @Autowired private MockMvc mockMvc;
  @MockBean private BlahTestCoreService blahTestCoreService;

...
import demo.v33.core.avc.v4.controller.AvcV4CoreServiceController;
import demo.v33.core.avc.v4.service.AvcV4CoreService;
import brave.SpanCustomizer;

@RunWith(SpringRunner.class)
@WebMvcTest(AvcV4CoreServiceController.class)
public class AvcV4CoreServiceControllerTest {

  @MockBean private JsonUtils jsonUtils;
  @MockBean private Logger logger;
  @Autowired private MockMvc mockMvc;
  @MockBean private AvcV4CoreService avcV4CoreService;
